import {
  selectSvgElement
} from "./chunk-7EDT6NSC.js";
import {
  JSON_SCHEMA,
  load
} from "./chunk-FRORFES4.js";
import {
  registerLayoutLoaders
} from "./chunk-45SZK6AP.js";
import "./chunk-CRDSD3UT.js";
import "./chunk-AYCROHPS.js";
import "./chunk-TNWHCC6S.js";
import "./chunk-WVT4LIGU.js";
import "./chunk-ZLWDVJFY.js";
import "./chunk-PKTDA3FU.js";
import {
  dedent
} from "./chunk-WITB2GFK.js";
import {
  registerIconPacks
} from "./chunk-YEFQK7U7.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
  ...
  removeDirectives,
  utils_default
} from "./chunk-WHUIYI6K.js";
import "./chunk-KI4OLBWQ.js";
import {
  UnknownDiagramError,
  addDirective,
  ...
  themes_default,
  updateSiteConfig
} from "./chunk-HHUUIDBB.js";
import {
  log,
  select_default,
  setLogLevel
} from "./chunk-DNFCJH2K.js";
import {
  __name
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-LMCZKHZV-DWCBP6GV.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-23GEKE2U-AYKCSOJI.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./swimlanesDiagram-G3AALYLV-EM2IVNV2.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-Q63AITRT-PIAPBTWY.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-IHSO6WYX-6OEYAM7G.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-NO4QXBWP-RH2X7GN2.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-FWYZ7A6U-XGFARVZS.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-ENE6RG2P-WHUNKGVS.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-ABIIQ3AL-542HDTG4.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-FW5EYKEG-RYC6RVV7.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-TGXJPOKE-VPKMKZN4.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-DBY2YBRQ-XMCJP57I.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-OUVF2IWQ-SFINZYV5.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-EOCWNBFH-VMQXLCPA.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-2N3HPSRC-P4VJANYU.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-6OUMAXLB-EMP3NU4Q.js");
...
var loader18 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-5HDEW3XC-6GGCWJZO.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-FHXFAJF6-PAF4K27S.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-LN4V7U3C-ZP7FW2QK.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-HUTT4EX6-SHUYTEH6.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-HTMAVEWB-EJ7HVQXE.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-NH7WQ7WH-YUP5GYUL.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-WEI45ONY-R5R3I3AZ.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-677ZJIJ3-SNPETMP6.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-OA4YK3LP-REC2MUMR.js");
...
var loader28 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-ZJ3FMSHR-3RPRAXQV.js");
...
var loader29 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-FQU43EPY-IXVFQWWV.js");
...
var loader30 = __name(async () => {
  const { diagram: diagram2 } = await import("./ishikawaDiagram-FXEZZL3T-B5N2YI3A.js");
...
var loader31 = __name(async () => {
  const { diagram: diagram2 } = await import("./vennDiagram-L72KCM5P-ZPNN5BOB.js");
...
var loader32 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-G47NLZAW-BZJJRP4E.js");
...
var loader33 = __name(async () => {
  const { diagram: diagram2 } = await import("./wardleyDiagram-EHGQE667-IW6YNUKA.js");
...
var loader34 = __name(async () => {
  const { diagram: diagram2 } = await import("./cynefinDiagram-TSTJHNR4-H72IG4GP.js");
...
var loader35 = __name(async () => {
  const { diagram: diagram2 } = await import("./railroadDiagram-RFXS5EU6-IZM3P3ZZ.js");
...
var loader36 = __name(async () => {
  const { diagram: diagram2 } = await import("./ebnfDiagram-CCIWWBDH-7UTVWGEE.js");
...
var loader37 = __name(async () => {
  const { diagram: diagram2 } = await import("./abnfDiagram-VRR7QNED-E322BJJF.js");
...
var loader38 = __name(async () => {
  const { diagram: diagram2 } = await import("./pegDiagram-2B236MQR-BRNK2UUW.js");
